...
class CreateOperationAction implements OperationActionInterface
{
    use HasOperation;
    ...
    {
        return [
            '{{scriptCreate}}' => $this->getScriptCreate(),
    ...
    {
        return $this->config()->getStubDirectory()  . DIRECTORY_SEPARATOR . 'operation' . DIRECTORY_SEPARATOR . 'action_create.stub';
    }
    ...
    public function getScriptCreate()
    {
		$data  = '';
        $data .= PHP_EOL;
